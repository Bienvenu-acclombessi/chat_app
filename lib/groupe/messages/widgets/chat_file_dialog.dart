...
class ChatFileDialog {
  ...
  String groupId;
  String othermessage;
  ChatFileDialog({required this.ref,required this.groupId, required this.othermessage});
        ...
        children: [
            ...
            Wrap(
              children: [
                ...
                ElevatedButton(onPressed: ()=>onSubmit(context,_keyForm,_file,groupId,messageController,filename), child: const Text('Envoyer') )
              ],
            )
        ],
      ),
...
Navigator.of(context).pop();
  ...
  void onSubmit(context,keyForm,file,groupId,messageController,filename)async{
