...
class ChatImageDialog {
  ...
  String friendUid;
  String othermessage;
  ChatImageDialog({this.user,required this.ref,required this.friendUid, required this.othermessage});
          ...
          Form(
            ...
            Wrap(
              children: [
                ...
                ElevatedButton(onPressed: ()=>onSubmit(context,_keyForm,_file,friendUid,messageController), child: const Text('Publier') )
              ],
            )
        ],
      ),
...
Navigator.of(context).pop();
  ...
  void onSubmit(context,keyForm,file,friendUid,messageController)async{
