              ...
              child: ClipRRect(
                ...
                child: ListView.builder(
                      ...
                      if(index+1<snapshot.data!.length){
                        ...
                        dateCours[index+1]=formattingDate(snapshot.data?[index+1].timeSent);
                      }
                      return Container(
                          margin: const EdgeInsets.only(top: 10),
                          child: Column(
                            children: [ index==0 ? SizedBox() : index+1< snapshot.data!.length ? dateCours[index]==dateCours[index+1] ? SizedBox() :
                                          Center(child: Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 8.0),
                                            child: Text(formattingDate(message.timeSent),style: const TextStyle(fontSize: 10,
                                            fontWeight: FontWeight.w400) ),
                                          ) ,) : SizedBox(),
                                          index==snapshot.data!.length-1 ? Center(child: Padding(
                                            padding: const EdgeInsets.symmetric(vertical: 8.0),
                                            child: Text(formattingDate(message.timeSent),style: const TextStyle(fontSize: 10,
                                            fontWeight: FontWeight.w400) ),
                                          ) ,) :SizedBox(),
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text('${formattingDateMessage(message.timeSent)}',
